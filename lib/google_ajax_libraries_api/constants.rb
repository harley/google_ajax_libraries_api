  ...
  module Google
    module AjaxLibraries
      ...
      SUPPORTED_VERSIONS = {
        ...
        JQUERYUI      => ['1', '1.5', '1.5.2', '1.5.3', '1.7', '1.7.0', '1.7.1', '1.7.2', '1.8.0'],
        PROTOTYPE     => ['1', '1.6', '1.6.0.2', '1.6.0.3', '1.6.1.0'],
        SCRIPTACULOUS => ['1', '1.8', '1.8.1', '1.8.2', '1.8.3'],
        MOOTOOLS      => ['1', '1.1', '1.11', '1.2', '1.2.1', '1.2.2', '1.2.3', '1.2.4'],
        DOJO          => ['1', '1.1', '1.1.1', '1.2', '1.2.0', '1.2.3', '1.3', '1.3.0', '1.3.1', '1.3.2', '1.4', '1.4.0', '1.4.1'],
        SWFOBJECT     => ['2', '2.1', '2.2'],
